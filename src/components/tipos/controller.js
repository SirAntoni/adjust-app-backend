...
async function crear_tipo(data) {
  try {
...
async function obtener_tipos(data){

    try{

        const resultado = await tipoDao.obtener_tipos(data);
...
async function obtener_tipo(data){
    try{
        ...
        const resultado = await tipoDao.obtener_tipo(datos_buscar,datos_obtener);
...
async function actualizar_tipo(params,data){
...
module.exports = {
  ...
  async obtener_tipos(req, res) {
    try {
      const data = req.query;
      const info = await obtener_tipos(data)
      return res.json(info)
    } catch (err) {
      info = {
        bEstado: false,
